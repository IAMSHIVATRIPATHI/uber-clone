...
<resources xmlns:ns1="http://schemas.android.com/tools" xmlns:ns2="urn:oasis:names:tc:xliff:document:1.2">
    ...
    <color name="stripe_3ds2_accent">@color/stripe_3ds2_primary</color>
    <color name="stripe_3ds2_background">@android:color/white</color>
    <color name="stripe_3ds2_chevron">#80000000</color>
    <color name="stripe_3ds2_control_activated">@color/stripe_3ds2_primary</color>
    <color name="stripe_3ds2_divider">#1E000000</color>
    <color name="stripe_3ds2_primary">#6C00F8</color>
    <color name="stripe_3ds2_primary_dark">#5500DE</color>
    <color name="stripe_3ds2_text_color">@android:color/black</color>
    ...
    <color name="stripe_3ds2_text_info_toggled">@color/stripe_3ds2_primary</color>
    <color name="stripe_3ds2_text_input_fill">#FAFAFA</color>
    <color name="stripe_3ds2_text_input_hint">#99000000</color>
    <color name="stripe_accent_color_default">#ff2296f3</color>
    <color name="stripe_add_payment_method_pressed">#3332325d</color>
    <color name="stripe_card_form_view_background_default">@android:color/transparent</color>
    <color name="stripe_card_form_view_background_disabled">#f8f8f8</color>
    <color name="stripe_card_form_view_form_border">#33787880</color>
    <color name="stripe_card_form_view_form_error">#cf6679</color>
    <color name="stripe_card_form_view_textinput_color">#e61a1a1a</color>
    <color name="stripe_card_form_view_textinput_disabled_color">#61000000</color>
    <color name="stripe_card_multiline_textinput_hint_color">#4D000000</color>
    <color name="stripe_card_widget_progress_background">#4F566B</color>
    <color name="stripe_card_widget_progress_foreground">#ffffffcc</color>
    <color name="stripe_clear_icon_tint">#1C1C1E</color>
    <color name="stripe_color_text_secondary_default">#ff32325d</color>
    <color name="stripe_color_text_unselected_primary_default">#ff000000</color>
    <color name="stripe_color_text_unselected_secondary_default">#80323232</color>
    <color name="stripe_control_normal_color_default">#ff90A4AE</color>
    <color name="stripe_divider_text_color">#99000000</color>
    <color name="stripe_error_text_dark_theme">#ffe85746</color>
    <color name="stripe_error_text_light_theme">#ffeb1c26</color>
    <color name="stripe_link_window_background">#FFFFFF</color>
    <color name="stripe_mandate_text_color">#FF888888</color>
    ...
    <color name="stripe_paymentsheet_background">#ffffff</color>
    <color name="stripe_paymentsheet_country_chevron_color">#000000</color>
    ...
    <color name="stripe_paymentsheet_form">#757575</color>
    ...
    <color name="stripe_paymentsheet_googlepay_divider_line">#1F000000</color>
    <color name="stripe_paymentsheet_googlepay_divider_text">#99000000</color>
    <color name="stripe_paymentsheet_googlepay_primary_button_background_color">#1F1F1F</color>
    <color name="stripe_paymentsheet_googlepay_primary_button_tint_color">#FFFFFF</color>
    <color name="stripe_paymentsheet_header_text">#565656</color>
    <color name="stripe_paymentsheet_link_mark">#000000</color>
    <color name="stripe_paymentsheet_payment_method_label_text">#DE000000</color>
    <color name="stripe_paymentsheet_payment_method_label_text_disabled">#61000000</color>
    <color name="stripe_paymentsheet_payment_option_selected_stroke">#1EA672</color>
    <color name="stripe_paymentsheet_payment_option_unselected_stroke">@android:color/transparent
    </color>
    ...
    <color name="stripe_paymentsheet_save_checkbox_color">#000000</color>
    ...
    <color name="stripe_swipe_start_payment_method">#DFDEDF</color>
    <color name="stripe_swipe_threshold_payment_method">#D5473F</color>
    ...
    <dimen name="stripe_3ds2_brand_zone_horizontal_margin">16dp</dimen>
    <dimen name="stripe_3ds2_brand_zone_max_height">100dp</dimen>
    <dimen name="stripe_3ds2_challenge_activity_padding">28dp</dimen>
    <dimen name="stripe_3ds2_challenge_zone_select_button_label_padding">14dp</dimen>
    <dimen name="stripe_3ds2_challenge_zone_select_button_min_height">48dp</dimen>
    <dimen name="stripe_3ds2_challenge_zone_select_button_offset_margin">-5dp</dimen>
    <dimen name="stripe_3ds2_challenge_zone_select_button_vertical_margin">15dp</dimen>
    <dimen name="stripe_3ds2_challenge_zone_text_indicator_padding">14dp</dimen>
    <dimen name="stripe_3ds2_challenge_zone_vertical_padding">8dp</dimen>
    <dimen name="stripe_3ds2_divider">1dp</dimen>
    <dimen name="stripe_3ds2_information_zone_label_padding">10dp</dimen>
    <dimen name="stripe_3ds2_information_zone_vertical_padding">30dp</dimen>
    <dimen name="stripe_activity_total_margin">8dp</dimen>
    <dimen name="stripe_add_address_vertical_margin">16dp</dimen>
    <dimen name="stripe_add_card_element_vertical_margin">12dp</dimen>
    <dimen name="stripe_add_card_expiry_middle_margin">8dp</dimen>
    <dimen name="stripe_add_card_total_margin">16dp</dimen>
    <dimen name="stripe_add_payment_method_vertical_padding">8dp</dimen>
    ...
    <dimen name="stripe_card_brand_spinner_dropdown_drawable_padding">5dp</dimen>
    <dimen name="stripe_card_brand_spinner_dropdown_padding">20dp</dimen>
    <dimen name="stripe_card_brand_spinner_dropdown_width">200dp</dimen>
    <dimen name="stripe_card_brand_spinner_image_height">21dp</dimen>
    <dimen name="stripe_card_brand_spinner_image_width">32dp</dimen>
    <dimen name="stripe_card_brand_view_height">21dp</dimen>
    <dimen name="stripe_card_brand_view_width">32dp</dimen>
    <dimen name="stripe_card_cvc_initial_margin">1000dp</dimen>
    <dimen name="stripe_card_expiry_initial_margin">200dp</dimen>
    <dimen name="stripe_card_form_view_card_elevation">1dp</dimen>
    <dimen name="stripe_card_form_view_error_text_margin_horizontal">17dp</dimen>
    <dimen name="stripe_card_form_view_error_textsize">13sp</dimen>
    <dimen name="stripe_card_form_view_text_input_layout_padding_horizontal">12dp</dimen>
    <dimen name="stripe_card_form_view_text_input_layout_padding_vertical">4dp</dimen>
    <dimen name="stripe_card_form_view_text_margin_horizontal">12dp</dimen>
    <dimen name="stripe_card_form_view_text_margin_vertical">4dp</dimen>
    <dimen name="stripe_card_form_view_text_minheight">48dp</dimen>
    <dimen name="stripe_card_form_view_textsize">14sp</dimen>
    <dimen name="stripe_card_icon_multiline_padding">8dp</dimen>
    <dimen name="stripe_card_icon_padding">12dp</dimen>
    ...
    <dimen name="stripe_card_widget_min_width">360dp</dimen>
    <dimen name="stripe_card_widget_progress_size">12dp</dimen>
    <dimen name="stripe_ciw_stripe_edit_text_size">18sp</dimen>
    <dimen name="stripe_cmw_edit_text_minheight">48dp</dimen>
    <dimen name="stripe_list_row_end_padding">8dp</dimen>
    <dimen name="stripe_list_row_height">48dp</dimen>
    <dimen name="stripe_list_row_start_padding">20dp</dimen>
    ...
    <dimen name="stripe_paymentsheet_add_payment_method_form_stroke_width">1dp</dimen>
    <dimen name="stripe_paymentsheet_add_pm_card_elevation">0dp</dimen>
    <dimen name="stripe_paymentsheet_add_pm_card_elevation_selected">1.5dp</dimen>
    <dimen name="stripe_paymentsheet_add_pm_card_height">60dp</dimen>
    <dimen name="stripe_paymentsheet_add_pm_card_stroke_width">1.5dp</dimen>
    <dimen name="stripe_paymentsheet_add_pm_card_stroke_width_selected">2dp</dimen>
    <dimen name="stripe_paymentsheet_add_pm_card_width">112dp</dimen>
    ...
    <dimen name="stripe_paymentsheet_card_stroke_width">1dp</dimen>
    <dimen name="stripe_paymentsheet_card_stroke_width_selected">2dp</dimen>
    ...
    <dimen name="stripe_paymentsheet_loading_container_height">100dp</dimen>
    <dimen name="stripe_paymentsheet_loading_indicator_size">24dp</dimen>
    <dimen name="stripe_paymentsheet_loading_indicator_stroke_width">2dp</dimen>
    ...
    <dimen name="stripe_paymentsheet_toolbar_elevation">4dp</dimen>
    ...
    <dimen name="stripe_toolbar_elevation">4dp</dimen>
    ...
    <item name="stripe_3ds2_default_challenge_zone_select_view_id" type="id"/>
    <item name="stripe_add_payment_method_footer" type="id"/>
    <item name="stripe_add_payment_method_form" type="id"/>
    <item name="stripe_default_reader_id" type="id"/>
    <item name="stripe_payment_methods_add_card" type="id"/>
    <item name="stripe_payment_methods_add_fpx" type="id"/>
    <item name="stripe_payment_methods_add_netbanking" type="id"/>
    <item name="stripe_payment_methods_footer" type="id"/>
    ...
    <integer name="stripe_card_widget_progress_fade_in_duration">600</integer>
    <integer name="stripe_card_widget_progress_fade_out_duration">300</integer>
    ...
    <plurals name="stripe_account_picker_cta_link">
        <item quantity="one">Link account</item>
        <item quantity="other">Link accounts</item>
    </plurals>
    <plurals name="stripe_account_picker_error_no_payment_method_desc">
        <item quantity="one">We found %1$s %2$s account but you can only link checking or savings accounts to %3$s. Please try selecting another bank.</item>
        <item quantity="other">We found %1$s %2$s accounts but you can only link checking or savings accounts to %3$s. Please try selecting another bank.</item>
    </plurals>
    <plurals name="stripe_attachlinkedpaymentaccount_desc">
        <item quantity="one">Please wait while your account is connected to %1$s</item>
        <item quantity="other">Please wait while your accounts are connected to %1$s</item>
    </plurals>
    <plurals name="stripe_attachlinkedpaymentaccount_desc_no_business">
        <item quantity="one">Please wait while your account is connected to this business</item>
        <item quantity="other">Please wait while your accounts are connected to this business</item>
    </plurals>
    ...
    <plurals name="stripe_success_pane_has_business_name">
    ...
    <plurals name="stripe_success_pane_has_connected_account_name">
        <item quantity="one">Your account was successfully linked to %1$s and %2$s through Stripe.</item>
        <item quantity="other">Your accounts were successfully linked to %1$s and %2$s through Stripe.</item>
    </plurals>
    <plurals name="stripe_success_pane_link_with_business_name">
        <item quantity="one">Your account was successfully connected to %1$s through Link.</item>
        <item quantity="other">Your accounts were successfully connected to %1$s through Link.</item>
    </plurals>
    <plurals name="stripe_success_pane_link_with_connected_account_name">
        <item quantity="one">Your account was successfully connected to %1$s and %2$s through Link.</item>
        <item quantity="other">Your accounts were successfully connected to %1$s and %2$s through Link.</item>
    </plurals>
    <plurals name="stripe_success_pane_link_with_no_business_name">
        <item quantity="one">Your account was successfully connected to Link.</item>
        <item quantity="other">Your accounts were successfully connected to Link.</item>
    </plurals>
    <plurals name="stripe_success_pane_networking_save_to_link_failed_no_business">
        <item quantity="one">Your account was connected to this business but could not be saved to Link with Stripe at this time.</item>
        <item quantity="other">Your accounts were connected to this business but could not be saved to Link with Stripe at this time.</item>
    </plurals>
    <plurals name="stripe_success_pane_no_business_name">
        <item quantity="one">Your account was successfully linked to Stripe.</item>
        <item quantity="other">Your accounts were successfully linked to Stripe.</item>
    </plurals>
    ...
    <string name="stripe_3ds2_brand_amex" translatable="false">American Express</string>
    <string name="stripe_3ds2_brand_cartesbancaires" translatable="false">Cartes Bancaires</string>
    <string name="stripe_3ds2_brand_discover" translatable="false">Discover</string>
    <string name="stripe_3ds2_brand_mastercard" translatable="false">Mastercard</string>
    <string name="stripe_3ds2_brand_unionpay" translatable="false">UnionPay</string>
    <string name="stripe_3ds2_brand_visa" translatable="false">Visa</string>
    ...
    <string name="stripe_acc_label_expiry_date">Expiration date</string>
    <string name="stripe_acc_label_expiry_date_node">%s, Expiration date</string>
    <string name="stripe_acc_label_zip">ZIP Code</string>
    <string name="stripe_acc_label_zip_short">ZIP</string>
    <string name="stripe_account_picker_confirm_account">Confirm your account</string>
    <string name="stripe_account_picker_cta_confirm">Confirm</string>
    ...
    <string name="stripe_account_picker_error_no_payment_method_title">No payment accounts available</string>
    <string name="stripe_account_picker_loading_desc">You\'re almost done.</string>
    <string name="stripe_account_picker_loading_title">Connecting your bank</string>
    ...
    <string name="stripe_account_picker_singleselect_account">Select an account</string>
    <string name="stripe_accountpicker_singleaccount_description">Select the account you\'d like to link.</string>
    ...
    <string name="stripe_address_label_neighborhood">Neighborhood</string>
    ...
    <string name="stripe_address_label_postal_code">Postal code</string>
    ...
    <string name="stripe_address_postal_code_invalid">Your postal code is invalid.</string>
    ...
    <string name="stripe_becs_widget_account_number_incomplete">Your account number is incomplete.</string>
    ...
    <string name="stripe_card_number_hint" translatable="false">1234 1234 1234 1234</string>
    ...
    <string name="stripe_cvc_amex_hint" translatable="false">CVV</string>
    <string name="stripe_cvc_multiline_helper" translatable="false">123</string>
    <string name="stripe_cvc_multiline_helper_amex" translatable="false">1234</string>
    <string name="stripe_cvc_number_hint" translatable="false">CVC</string>
    ...
    <string name="stripe_expiration_date_allowlist" translatable="false">0123456789/</string>
    ...
    <string name="stripe_google_pay" translatable="false">Google Pay</string>
    <string name="stripe_iban">IBAN</string>
    ...
    <string name="stripe_inline_sign_up_header">Save my info for secure 1-click checkout</string>
    <string name="stripe_institutionpicker_manual_entry_desc">Enter your account and routing numbers</string>
    <string name="stripe_institutionpicker_manual_entry_title">Don’t see your bank?</string>
    <string name="stripe_institutionpicker_no_results_desc">Double check your spelling and search terms</string>
    <string name="stripe_institutionpicker_no_results_title">No results</string>
    ...
    <string name="stripe_invalid_zip">Your postal code is incomplete.</string>
    ...
    <string name="stripe_link">Link</string>
    ...
    <string name="stripe_link_account_picker_title_nobusiness">Select an account to connect to this business</string>
    ...
    <string name="stripe_manualentry_account_type_disclaimer">Please enter a checking account.</string>
    ...
    <string name="stripe_paymentsheet_payment_method_afterpay">Afterpay</string>
    ...
    <string name="stripe_postalcode_placeholder" translatable="false">12345</string>
    ...
    <string name="stripe_processing_error">There was an error processing your card -- try again in a few seconds</string>
    ...
    <string name="stripe_sign_up_message">Pay faster at %s and thousands of merchants.</string>
    ...
    <string name="stripe_verification.codeExpired">It looks like the verification code you provided is not valid anymore. Get a new code and try again.</string>
    <string name="stripe_verification.codeExpiredEmail">It looks like the verification code you provided is not valid anymore. Click “Resend code” and try again, or <annotation clickable="contact_us">Contact us</annotation>.</string>
    <string name="stripe_verification.codeExpiredSms">It looks like the verification code you provided is not valid anymore. Try again, or <annotation clickable="contact_us">Contact us</annotation>.</string>
    <string name="stripe_verification.codeInvalid">Hmm, that code didn’t work. Double check it and try again.</string>
    ...
    <item name="shapeCornerFamily">@macro/m3_sys_shape_corner_full_family</item>
    ...
    <item name="motionPath">@macro/m3_sys_motion_path</item>
    ...
    <style name="BaseStripe3DS2EditText" parent="Widget.MaterialComponents.TextInputEditText.OutlinedBox"/>
    <style name="BaseStripe3DS2TextInputLayout" parent="Widget.MaterialComponents.TextInputLayout.OutlinedBox"/>
    <style name="BaseStripe3DS2Theme" parent="Theme.MaterialComponents.Light.DarkActionBar">
        ...
        <item name="editTextColor">@color/stripe_3ds2_text_edit</item>
        <item name="textInputStyle">@style/Stripe3DS2TextInputLayout</item>
    </style>
    <style name="BaseStripe3ds2ProgressTheme" parent="Theme.MaterialComponents.Light.NoActionBar">
        <item name="android:colorBackground">@color/stripe_3ds2_background</item>
        <item name="colorPrimary">@color/stripe_3ds2_primary</item>
        <item name="colorPrimaryDark">@color/stripe_3ds2_primary_dark</item>
        <item name="colorAccent">@color/stripe_3ds2_accent</item>
    ...
    <style name="Stripe.Base.BecsDebitWidget.MandateAcceptanceTextView" parent="Widget.AppCompat.TextView">
    ...
    <style name="Stripe.Base.CardInputWidget.EditText" parent="Widget.AppCompat.EditText">
        <item name="android:textSize">@dimen/stripe_ciw_stripe_edit_text_size</item>
    </style>
    ...
    <style name="Stripe.BecsDebitWidget.EditText" parent="Stripe.Base.BecsDebitWidget.EditText"/>
    <style name="Stripe.BecsDebitWidget.MandateAcceptanceTextView" parent="Stripe.Base.BecsDebitWidget.MandateAcceptanceTextView"/>
    ...
    <style name="Stripe.CardMultilineWidget.TextInputLayout" parent="Stripe.Base.CardMultilineWidget.TextInputLayout">
        <item name="android:textColorHint">@color/stripe_card_multiline_textinput_hint_color</item>
    </style>
    <style name="Stripe3DS2ActionBar" parent="Widget.AppCompat.ActionBar.Solid">
        <item name="contentInsetStart">@dimen/stripe_3ds2_challenge_activity_padding</item>
        <item name="background">?attr/colorPrimary</item>
    ...
    <style name="Stripe3DS2Divider">
        <item name="android:background">@color/stripe_3ds2_divider</item>
        <item name="android:layout_height">@dimen/stripe_3ds2_divider</item>
        <item name="android:layout_width">match_parent</item>
    </style>
    <style name="Stripe3DS2Divider.Vertical">
        <item name="android:layout_width">@dimen/stripe_3ds2_divider</item>
        <item name="android:layout_height">match_parent</item>
    </style>
    <style name="Stripe3DS2EditText" parent="BaseStripe3DS2EditText"/>
    <style name="Stripe3DS2FooterChevron">
        <item name="tint">@color/stripe_3ds2_chevron</item>
    </style>
    <style name="Stripe3DS2FooterHeader">
        <item name="android:textColor">@color/info_zone_header_text</item>
    </style>
    <style name="Stripe3DS2FooterText"/>
    <style name="Stripe3DS2FullScreenDialog">
        <item name="android:windowFrame">@null</item>
        <item name="android:windowIsFloating">true</item>
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowAnimationStyle">@android:style/Animation.Dialog</item>
    </style>
    <style name="Stripe3DS2HeaderTextViewStyle">
        <item name="android:textSize">20sp</item>
        <item name="android:textStyle">bold</item>
    </style>
    ...
    <style name="Stripe3DS2TextInputLayout" parent="BaseStripe3DS2TextInputLayout"/>
    <style name="Stripe3DS2TextViewStyle">
        <item name="android:textSize">14sp</item>
    </style>
    <style name="Stripe3DS2Theme" parent="BaseStripe3DS2Theme"/>
    <style name="Stripe3ds2ProgressTheme" parent="BaseStripe3ds2ProgressTheme"/>
    <style name="StripeActionButtonStyle" parent="Widget.AppCompat.ActionButton">
        <item name="android:paddingStart">16dp</item>
        <item name="android:paddingEnd">16dp</item>
    </style>
    <style name="StripeAlertDialogStyle" parent="Theme.AppCompat.DayNight.Dialog"/>
    ...
    <style name="StripeCardErrorTextView">
        <item name="android:imeOptions">actionDone</item>
        <item name="android:textColor">@color/stripe_card_form_view_form_error</item>
        <item name="android:textSize">@dimen/stripe_card_form_view_error_textsize</item>
    ...
    <style name="StripeCardFormCountryItem">
        <item name="android:inputType">none</item>
        <item name="android:editable">false</item>
        <item name="android:maxLines">1</item>
        <item name="android:textSize">@dimen/stripe_card_form_view_textsize</item>
        <item name="android:letterSpacing">-0.01</item>
        <item name="android:textColor">@color/stripe_card_form_view_text_color</item>
        <item name="android:paddingTop">13dp</item>
        <item name="android:paddingBottom">13dp</item>
    </style>
    <style name="StripeCardFormCountryTextInputLayout" parent="Widget.MaterialComponents.TextInputLayout.OutlinedBox.ExposedDropdownMenu">
    ...
    <style name="StripeCardFormEditText">
        <item name="android:imeOptions">actionDone</item>
        <item name="android:textColor">@color/stripe_card_form_view_text_color</item>
        <item name="android:textSize">@dimen/stripe_card_form_view_textsize</item>
        <item name="android:background">@android:color/transparent</item>
        <item name="android:minHeight">@dimen/stripe_card_form_view_text_minheight</item>
    </style>
    <style name="StripeCardFormTextInputLayout" parent="Widget.Design.TextInputLayout">
        <item name="android:paddingStart">
            @dimen/stripe_card_form_view_text_input_layout_padding_horizontal
        </item>
        <item name="android:paddingEnd">
    ...
    <style name="StripeCardFormView.Borderless">
        <item name="cardFormStyle">borderless</item>
    </style>
    ...
    <style name="StripePaymentSheetFormDivider">
        <item name="android:layout_width">match_parent</item>
        <item name="android:layout_height">1dp</item>
        <item name="android:background">@color/stripe_paymentsheet_form_border</item>
    </style>
    ...
    <style name="StripeTransparentTheme" parent="@style/Theme.MaterialComponents.DayNight.NoActionBar">
        <item name="android:windowIsTranslucent">true</item>
        <item name="android:windowBackground">@android:color/transparent</item>
        <item name="android:windowContentOverlay">@null</item>
        <item name="android:windowNoTitle">true</item>
    ...
    <style name="StripeVerticalDivider">
    ...
    <item name="fontFamily">@macro/m3_ref_typeface_plain_regular</item>
    <item name="android:fontFamily">@macro/m3_ref_typeface_plain_regular</item>
    <item name="android:textStyle">normal</item>
    ...
    <item name="fontFamily">@macro/m3_ref_typeface_brand_regular</item>
    <item name="android:fontFamily">@macro/m3_ref_typeface_brand_regular</item>
    <item name="android:textStyle">normal</item>
    ...
    <item name="fontFamily">@macro/m3_ref_typeface_plain_medium</item>
    <item name="android:fontFamily">@macro/m3_ref_typeface_plain_medium</item>
...
<item name="maskedWalletDetailsLogoImageType">android_pay</item>
    ...
    <declare-styleable name="BecsDebitWidget" ns1:ignore="ResourceName">
        <attr format="string" name="companyName"/>
    </declare-styleable>
    ...
    <declare-styleable name="CardElement" ns1:ignore="ResourceName">
        <attr format="boolean" name="shouldShowPostalCode"/>
        <attr format="boolean" name="shouldRequirePostalCode"/>
        <attr format="boolean" name="shouldRequireUsZipCode"/>
    </declare-styleable>
    <declare-styleable name="CardInputView" ns1:ignore="ResourceName">
        <attr format="string" name="cardHintText"/>
        <attr format="color" name="cardTint"/>
        <attr format="color" name="cardTextErrorColor"/>
...
<attr format="string" name="mapId"/>
    ...
    <declare-styleable name="PayButtonAttributes"><attr name="buttonTheme">
...
<attr format="reference|string" name="scopeUris"/>
    ...
    <declare-styleable name="StripeCardFormView" ns1:ignore="ResourceName">
        <attr format="enum" name="cardFormStyle">
            <enum name="standard" value="0"/>
            <enum name="borderless" value="1"/>
        </attr>
        <attr format="reference" name="backgroundColorStateList"/>
    </declare-styleable>
    <declare-styleable name="StripeCountryAutoCompleteTextInputLayout" ns1:ignore="ResourceName">
        <attr format="reference" name="countryAutoCompleteStyle"/>
        <attr format="reference" name="countryItemLayout"/>
    </declare-styleable>
...
<enum name="monochrome" value="2"/>
    ...
    <macro name="m3_ref_typeface_brand_medium">sans-serif-medium</macro>
    <macro name="m3_ref_typeface_brand_regular">sans-serif</macro>
    <macro name="m3_ref_typeface_plain_medium">sans-serif-medium</macro>
    <macro name="m3_ref_typeface_plain_regular">sans-serif</macro>
    ...
    <macro name="m3_sys_motion_path">linear</macro>
    <macro name="m3_sys_shape_corner_extra_large_family">rounded</macro>
    <macro name="m3_sys_shape_corner_extra_small_family">rounded</macro>
    <macro name="m3_sys_shape_corner_full_family">rounded</macro>
    <macro name="m3_sys_shape_corner_large_family">rounded</macro>
    <macro name="m3_sys_shape_corner_medium_family">rounded</macro>
    <macro name="m3_sys_shape_corner_none_family">rounded</macro>
    <macro name="m3_sys_shape_corner_small_family">rounded</macro>
</resources>